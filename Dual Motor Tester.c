...
#pragma config(Motor,  mtr_S1_C1_1,     S1C1,          tmotorTetrix, openLoop)
#pragma config(Motor,  mtr_S1_C1_2,     S1C2,          tmotorTetrix, openLoop)
#pragma config(Motor,  mtr_S1_C2_1,     S2C1,          tmotorTetrix, openLoop)
#pragma config(Motor,  mtr_S1_C2_2,     S2C2,          tmotorTetrix, openLoop)
#pragma config(Motor,  mtr_S1_C3_1,     S3C1,          tmotorTetrix, openLoop)
#pragma config(Motor,  mtr_S1_C3_2,     S3C2,          tmotorTetrix, openLoop)
#pragma config(Motor,  mtr_S1_C4_1,     S4C1,          tmotorTetrix, openLoop)
#pragma config(Motor,  mtr_S1_C4_2,     S4C2,          tmotorTetrix, openLoop)
